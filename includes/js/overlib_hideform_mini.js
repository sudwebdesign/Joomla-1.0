...
//\
//\  overLIB 4.05.2016 - You may not remove or change this notice.
...
x+=o['offset'+t]
return x}
if(!(olNs4||olOp||olIe55||navigator.userAgent.indexOf('Netscape6')!=-1)){var MMStr=olMouseMove.toString();var strRe=/(if\s*\(o3_allowmove\s*==\s*1\))/;var f=MMStr.match(strRe);
if(f){var ls=MMStr.search(strRe);ls+=f[1].length;var le=MMStr.substring(ls).search(/[;|}]\n/);MMStr=MMStr.substring(0,ls)+' {runHook("placeLayer",FREPLACE);if(olHideForm)hideSelectBox();}'+MMStr.substring(ls+(le!=-1?le+3:0)+31);document.writeln('<script type="text/javascript">\n<!--\n'+MMStr+'\n//-->\n</'+'script>')}
